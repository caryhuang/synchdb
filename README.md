...
## Run SynchDB Test
Refer to `testenv/README.md` or visit our documentation page [here](https://docs.synchdb.com/user-guide/prepare_tests_env/) to prepare a sample MySQL and SQLServer or Oracle database instances for testing.
