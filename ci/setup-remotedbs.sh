...
ALTER DATABASE ADD LOGFILE GROUP 7 ('/opt/oracle/oradata/FREE/redo07.log') SIZE 512M;
ALTER DATABASE ADD LOGFILE GROUP 8 ('/opt/oracle/oradata/FREE/redo08.log') SIZE 512M;
