...
ALTER DATABASE ADD LOGFILE GROUP 9 ('/opt/oracle/oradata/FREE/redo09.log') SIZE 1G;
ALTER DATABASE ADD LOGFILE GROUP 10 ('/opt/oracle/oradata/FREE/redo10.log') SIZE 1G;
exit;
EOF
