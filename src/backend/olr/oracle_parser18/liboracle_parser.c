...
/* the following functions are based on ivorysql source code with all logics stripped off 
 * these are not required by synchdb and are put here simply for the oracle parser to compile
 */
bool
get_bindByName(void)
{
